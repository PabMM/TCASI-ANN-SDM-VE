...
Bw = 1e4;
data_path = [cd,'\VAL-DS\Multiple-Iterations-OPT\classifierGB_3orCascadeSDM_val_'];
% Load model
...
%%
save(['VAL-DS/sim_3orSC_LUTGB_',num2str(num_iterations),'.mat'],"SNR_asked","SNR_sim","power_sim","power_asked","fom_sim","fom_asked")
