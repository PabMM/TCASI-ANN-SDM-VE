...
data_path = [cd,'\VAL-DS\Multiple-Iterations-OPT\Classifier',classifier_model,'_211CascadeSDM_val_']; % Classifier
% Load model
...
%%
save(['VAL-DS/sim_211Cascade_OPTGB_',num2str(num_iterations),'.mat'],"SNR_asked","SNR_sim","power_sim","power_asked","fom_sim","fom_asked")
